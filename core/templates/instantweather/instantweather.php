	...
	<br>
		...
		<?php 
			...
			if(!$last_location->arricao){
				...
				<br>
				<small style="color:#a3a3a3;">Updated <?php echo $observation_time;?>  |  InstantWeather Module v1.9 <?php echo $copyright; ?> <?php MainController::Run('InstantWeather', 'chk_update', ''); ?>
					<br>
					<br>
